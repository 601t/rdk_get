...
## 使い方
1. 出力に従います。<br>
   以前のスクリプトと異なり、番組の日付やタイトルを入れる必要がなくなりました。ただしURLを入力する必要があります。(例: `https://radiko.jp/#!/ts/LFR/20250615010000`)
2. お住いの地域外の番組を保存したい場合はauthtokenを別途用意してください。これの[入手](https://github.com/jackyzy823/rajiko)方法は調べて各自工夫をしてください。
3. オプション: [rsgain](https://github.com/complexlogic/rsgain)が入っているとリプレイゲインが適用できます。
